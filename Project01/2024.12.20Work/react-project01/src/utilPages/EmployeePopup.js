        ...
        return (
            <div className='employee_popup_menu' style={{ top: y, left: x }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', whiteSpace: 'nowrap' }}>
                    직급:<select value={employee.position_rank} onChange={(e) => onClose(employee.company_id, e.target.value, -1)}>
                        {positions.map((p) => (
                ...
                <div style={{ display: 'flex', alignItems: 'center', whiteSpace: 'nowrap' }}>
                    부서:<select value={employee.department_no} onChange={(e) => onClose(employee.company_id, -1, e.target.value)}>
