  ...
  return (
    <div id='company_site'>
      ...
      <div id='main_middle_box'>
        ...
        <button id='project_history_button' onClick={() => PageRoad('project_history')}>프로젝트 연혁</button>&nbsp;
        {loginRank > 0 && <button id='collaborative_project_button' onClick={() => PageRoad('project_management')}>협업 프로젝트</button>} &nbsp;
