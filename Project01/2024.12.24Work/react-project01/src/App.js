  ...
  return (
    <div id='company_site'>
      ...
      <div id='main_middle_box'>
        ...
        {loginRank <= 0 && <button id='board_management_button'>게시판 관리</button>} &nbsp;
      </div>
      <hr />
      <div id='main_bottom_box'>
        ...
        {'board_read' === page && <BoardRead loginName={loginName} category={boardCategory} postNo={postNo} page={BoardPageRoad} readPage={readPageNo}/>}
