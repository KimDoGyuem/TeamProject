...
function BoardGetList({ category, page, readPage, loginRank }) {    //{/* ★여기수정 */}
    ...
    const shouldShowButton = !(category === '공지' && loginRank > 0);   //{/* ★여기수정 */}
    ...
    return (
        <div id='board_get_list_page'>
            <div id='list_box'>
                ...
                {shouldShowButton && <button id='main_button' onClick={() => page('board_write')}>글쓰기</button>}  {/* ★여기수정 */}
                <hr />
