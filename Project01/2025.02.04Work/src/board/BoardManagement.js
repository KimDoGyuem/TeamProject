            ...
            <div id='management_box'>
                ...
                <table id='management_table'>
                    <tbody>
                        <tr>
                            ...
                            <td className='td1' style={{ width: '8%' }}>조회수<button onClick={handleSortByHits} style={{ width: '25px', paddingLeft: '2px' }}>
                ...
                <div id='button_box'>
                    <div id='category_button_box'>
                        <button className={searchCategory === '' ? 'select_button' : 'unSelect_button'} onClick={allList}>모든글 리스트</button>
                    ...
                    <div id='util_button_box'>
                        <button className={selButton ? 'select_button' : 'unSelect_button'} value="av" onClick={(e) => viewSelect(e.target.value)}>전체글 보기</button>
