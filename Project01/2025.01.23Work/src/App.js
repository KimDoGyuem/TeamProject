  ...
  return (
    <div id='company_site'>
      ...
      <div id='main_bottom_box'>
        ...
        {'main' === page &&
          <div>
            <div id='banner_box'><img id='banner' src={banner} alt='company_banner.jpg'></img></div>
            <div id='contents_box'>뭔가 회사 메인 콘텐츠 같은거 나오면 좋을듯</div>
          </div>
        }
        ...
        {'board_getList' === page && <BoardGetList category={boardCategory} page={PageRoad} readPage={readPageNo} loginRank={loginRank} />} 
