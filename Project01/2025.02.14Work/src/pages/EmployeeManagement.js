...
function EmployeeManagement() {
    ...
    function axiosAddDepartment(e) {
        e.preventDefault();
        axios.post(`http://localhost:8080/spring/company/addDepartment?name=${departmentName}`)
        .then(() => {
    ...
    function deleteEmployee(id) {
        axios.delete(`http://localhost:8080/spring/company/deleteEmployee?id=${id}`)
        .then(() => {
    ...
    function changePosition(b1) {
        axios.patch('http://localhost:8080/spring/company/changePosition', b1)
        .then(() => {
            axiosGetDepartmentList();
            axiosGetEmployeeList();
        })
    ...
    function departmentMemberAdd(b2) {
        axios.patch('http://localhost:8080/spring/company/departmentMemberAdd', b2)
            .then(() => {
                axiosGetDepartmentList();
                axiosGetEmployeeList();
            })
        ...
        function emExclude(id) {
            axios.patch(`http://localhost:8080/spring/company/emExclude?id=${id}`)
            .then(() => {
                axiosGetDepartmentList();
            })
            .catch(error => {
        ...
        function deleteDepartment(departmentName) {
            axios.delete(`http://localhost:8080/spring/company/deleteDepartment?department=${departmentName}`)
            .then(() => {
                axiosGetDepartmentList();
                axiosGetEmployeeList();
            })
        ...
        axios.patch('http://localhost:8080/spring/company/departmentLeader', b)
        .then(() => {
            axiosGetDepartmentList();
        })
        .catch(error => {
