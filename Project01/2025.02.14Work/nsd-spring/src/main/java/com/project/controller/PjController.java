...
public class PjController {
	...
	@RequestMapping("/checkProjectFinished")
	public boolean checkProjectFinished(@RequestParam("pjNo") int pjNo) {
		List<Integer> endedProjects = service.endCheck();
		return endedProjects.contains(pjNo);
	}
}
