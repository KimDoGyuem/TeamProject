...
function BoardRead({ loginId, loginName, postNo, page, readPage }) {
    ...
    function axiosGetCommentsRead() {
        axios.get(`${LocalUrl()}/companyBoard/commentsRead?commentNo=${postNo}`)
            .then((response) => {
    ...
    function axiosCommentsWrite(e) {
        ...
        if (comment === '') {
            ...
            axios.post(`${LocalUrl()}/companyBoard/commentsWrite`, body)
                .then(() => {
                    setcomment('');
                    axiosGetCommentsRead();
                })
    ...
    function axiosDeletePost() {
        axios.patch(`${LocalUrl()}/companyBoard/deletePost?postNo=${postNo}`)
            .then(() => {
    ...
    function axiosDeleteComment(no) {
        axios.patch(`${LocalUrl()}/companyBoard/deleteComment?no=${no}`)
            .then(() => {
