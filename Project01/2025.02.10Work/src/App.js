  ...
  return (
    <div id={!admin ? 'company_site_user' : 'company_site_admin'}>
      ...
      <div id='main_bottom_box'>
        ...
        {/* 변경점 */}
        {'project_status' === page && <ProjectManagement loginRank={loginRank} LoginID={loginId} />}
        {'project_management' === page && <ProjectManagement loginRank={loginRank} LoginID={loginId} />}
