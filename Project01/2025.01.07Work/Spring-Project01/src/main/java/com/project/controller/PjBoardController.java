...
public class PjBoardController {
	...
	public ArrayList<CompanyBoardDto> getAllPostList(@RequestParam("searchTag")String searchTag, @RequestParam("searchWord")String searchWord, @RequestParam("del")boolean d){
		if(d==false) {
			System.out.println("d는 거짓임");
		}else {
			System.out.println("d는 참임");
		}
...
//	@RequestMapping("/getAllPostList")
//	public ArrayList<CompanyBoardDto> getAllPostList(@RequestParam("searchTag")String searchTag, @RequestParam("searchWord")String searchWord){
//		ArrayList<CompanyBoardDto> c = service.getAllPostList(searchTag,searchWord);
//		return c;
//	}
